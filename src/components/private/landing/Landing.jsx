      ...
      <div className="container landing_parent">
        ...
        <div className="landing_promo">
          ...
          <span>
            {" "}
            {windowWidth > 430
              ? "Empowering Abilities, Enriching Lives: Together for Inclusion!"
              : "We are OpenSource, contribute now !"}{" "}
          </span>
        </div>

        <h1>
          WELCOME TO <span>EMPOWERLINK</span>
        </h1>
        ...
        {windowWidth > 430 ? (
          <h2>
            ...
            Our Work aims to empower <span>diffrently-abled</span> people by connecting them with NGOs and 
            <span> build</span> a better tomorrow  
          </h2>
        ) : (
          <h2>
